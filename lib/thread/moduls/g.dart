...
import 'package:Paws/thread/moduls/posts.dart';
...
Post post1 = new Post(
    new AssetImage('assets/images/cat1.png'),
    user,
    "My first post",
    DateTime.now(),
...
User follower1 = new User(
    'the_rock', AssetImage('assets/images/cat1.png'), [], [], [], [], true);
User follower2 = new User(
    'miley_cyrus', AssetImage('assets/images/cat1.png'), [], [], [], [], false);
User follower3 = new User(
    'kim_k', AssetImage('assets/images/cat1.png'), [], [], [], [], true);
User follower4 = new User(
    'daredevil', AssetImage('assets/images/cat1.png'), [], [], [], [], true);
User follower5 = new User(
    'batman', AssetImage('assets/images/cat1.png'), [], [], [], [], true);
User follower6 = new User('peter_griffin', AssetImage('assets/images/cat1.png'),
    [], [], [], [], false);
List<Post> userPosts = [
  new Post(
      new AssetImage('assets/images/cat1.png'),
